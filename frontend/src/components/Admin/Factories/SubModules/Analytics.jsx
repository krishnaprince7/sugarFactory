...
const Analytics = () => {
  ...
  // Data for Top Detection Types
  const detectionTypes = [
    { name: 'Double Gross', percent: 28, color: 'bg-blue-800' },
    { name: 'Human on Seat', percent: 35, color: 'bg-[#06B6D4]' }, // Cyan
  ...
  // Data for Monthly Summary Report
  const monthlyStats = [
    ...
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm">
          <h2 className="text-xl font-bold text-[#1A2A44] mb-5">Weekly Performance</h2>
            ...
            {weeklyData.map((data, index) => (
              ...
              >
                ...
                <span className="text-sm text-gray-900">
                  <span className="font-bold">{data.alerts}</span> alerts • <span className="font-bold">{data.accuracy}%</span> accuracy
                </span>
              </div>
            ))}
          </div>
        ...
        {/* ================= 2. Top Detection Types ================= */}
        <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm">
          <h2 className="text-xl font-bold text-[#1A2A44] mb-5">Top Detection Types</h2>
      ...
      <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm mb-8">
        <h2 className="text-xl font-bold text-[#1A2A44] mb-5">Monthly Summary Report</h2>
