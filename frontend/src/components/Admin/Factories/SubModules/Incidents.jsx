...
import { FiClock, FiUser, FiMessageSquare, FiPlay } from "react-icons/fi";
      ...
      {incidentsData.map((incident) => (
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <span
              className={`px-2.5 py-0.5 text-xs font-semibold rounded-full capitalize ${getBadgeStyle(incident.status)}`}
            >
              {incident.status}
            </span>
          </div>
